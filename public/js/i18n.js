...
(function () {
  ...
  const DICT = {
    ru: {
      ...
      'auth.forgot': 'Забыли пароль?', 'auth.admin_login': 'Логин администратора',
      'auth.recovery_code': 'Код восстановления', 'auth.new_password': 'Новый пароль (минимум 12 символов)',
      'auth.recovery_hint': 'Введите логин. Администратор или куратор проверит заявку и отправит новый доступ на WhatsApp родителя.',
      'auth.restore': 'Отправить заявку', 'auth.restored': 'Заявка отправлена ответственному сотруднику.',
      ...
      'admin.sipuni': 'Телефония Sipuni', 'admin.grp_telephony': 'Телефония',
      'admin.requests': 'Заявки родителей',
    ...
    kk: {
      ...
      'auth.forgot': 'Құпиясөзді ұмыттыңыз ба?', 'auth.admin_login': 'Әкімші логині',
      'auth.recovery_code': 'Қалпына келтіру коды', 'auth.new_password': 'Жаңа құпиясөз (кемінде 12 таңба)',
      'auth.recovery_hint': 'Логинді енгізіңіз. Әкімші немесе куратор өтінімді тексеріп, жаңа кіру деректерін ата-ананың WhatsApp нөміріне жібереді.',
      'auth.restore': 'Өтінім жіберу', 'auth.restored': 'Өтінім жауапты қызметкерге жіберілді.',
      ...
      'admin.sipuni': 'Sipuni телефониясы', 'admin.grp_telephony': 'Телефония',
      'admin.requests': 'Ата-ана өтінімдері',
